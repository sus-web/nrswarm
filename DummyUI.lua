-- Этот файл я сделал чтобы ты мог легко  изучить библиотеку, но используй её через httpget https://raw.githubusercontent.com/hm5650/DummyUi/refs/heads/main/DummyUI.lua
